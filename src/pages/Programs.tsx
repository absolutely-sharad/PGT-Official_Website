  ...
  const programs = [
    {
      ...
      icon: Target,
      description:
        'Comprehensive digital transformation initiative focusing on technology adoption, digital literacy, and innovation-driven growth.',
      features: [
    ...
    },
    {
      ...
      icon: Users,
      description:
        'Empowering communities through advocacy, leadership development, and social action programs that create lasting change.',
      features: [
    ...
    },
    {
      ...
      icon: GraduationCap,
      description:
        'Educational seminars and workshops designed to enhance skills, knowledge, and professional development across various domains.',
      features: [
    ...
    },
    {
      ...
      icon: Brain,
      description:
        'Psychological wellness and motivation programs focusing on mental health, resilience, and personal growth.',
      features: [
    ...
    },
    {
      ...
      icon: Zap,
      description:
        'Comprehensive higher education support program focusing on academic excellence, career guidance, and research opportunities.',
      features: [
        'Academic Mentoring',
          ...
          <AnimatedCard animation="slideUp">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                From digital transformation to personal development, our programs are designed to meet diverse needs
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <AnimatedCard animation="fadeIn">
            ...
            <p className="text-lg mb-8 max-w-2xl mx-auto text-green-100">
              Take the next step in your transformation journey. Our programs are designed to support you every step of
              the way.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center max-w-md mx-auto">
              {/* Apply Now Button - Google Form Link */}
              <a
                href="https://docs.google.com/forms/d/e/1FAIpQLScuNgMbLFhWx-yLSNK-b0JnMeWNdREAYTVi8owvWrxNgXwmRw/viewform"
                target="_blank"
                rel="noopener noreferrer"
                className="bg-white text-green-600 px-6 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-all duration-300 hover:scale-105 inline-flex items-center justify-center shadow-lg"
              >
                Apply Now
                <ArrowRight className="ml-2 h-5 w-5" />
              </a>
